...
// @include        https://immobilienscout24.tld/*
// @include        https://www.immobilienscout24.tld/*
...
(function($) {
 ...
 function entry() {
      var
      $$ = $(this),
          $KM = $$.find('dt:contains("Kaltmiete")').prev(),
          $WF = $$.find('dt:contains("Wohnfläche")').prev();
  ...
  $(function() {
      $('.result-list__listing').each(entry);
  });
